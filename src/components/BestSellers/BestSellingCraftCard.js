...
const BestSellingCraftCard = ({ product }) => {
  ...
  return (
    <Link href={`/product/${productSlug}/${product._id}`}>
      <div className="bg-white cursor-pointer rounded-xl overflow-hidden border border-neutral-200 hover:shadow-md transition">
        <div className="relative bg-[#eae2d6] h-[220px] flex items-center justify-center">
          {discount > 0 && (
          ...
          <button  onClick={(e) => {
                ...
                e.stopPropagation();
                addToWishlist();
              }} className="absolute top-3 right-3 cursor-pointer bg-white rounded-full p-2 shadow">
            <Heart size={16} />
          </button>
